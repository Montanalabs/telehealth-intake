...
- `telehealth-intake_safe.os` — the correct design.
- `telehealth-intake_unsafe.os` — the tempting-but-wrong version (the negative example a model must learn to reject).
