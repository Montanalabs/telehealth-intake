...
- `telehealth-intake_safe.eide` — the correct design.
- `telehealth-intake_unsafe.eide` — the tempting-but-wrong version (the negative example a model must learn to reject).
